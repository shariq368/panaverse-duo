        ...
        <div className=" grid sm:grid-cols-1 md:grid-cols-2 mb-20 gap-8  sm:px-0">
        
          {
            Coretrackdata.map((item , i) => (
                            <div key={title} className="p-6 mt-20 md:p-14 lg:p-24 lg:mx-28  border rounded-lg shadow-xl bg-[#DBDBDB] backdrop:blur-md border-purple-500 text-center md:text-left hover:scale-105 duration-1000 hover:bg-[#e0aaff]  ">
