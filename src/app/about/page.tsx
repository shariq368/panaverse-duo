...
import Picture from "../../../public/assets/image/Ellipse 1.png"
...
const About = () => {
  ...
  <div className="container mx-auto flex px-5 py-24 items-center justify-center flex-col">
    ...
    <div className="text-center lg:w-2/3 w-full">
      <h1 className="title-font sm:text-3xl text-4xl font-semibold text-gray-900">
        Dr. Arif Alvi
      </h1>
      <div className="pt-24 leading-relaxed -mt-20 text-justify">
      <p className="pb-3 font-medium text-center">President of the Islamic Public of Pakistan</p>
      <p className="pb-3">Dr. Arif Alvi was born in as the 13th President of Islamic Republic of Pakistan on 9th September 2018. </p>
      <p className="pb-3">
